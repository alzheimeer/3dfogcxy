      ...
      <div class="rounded-xl bg-gray-800 bg-opacity-50 px-16 py-10 shadow-lg backdrop-blur-md max-sm:px-8">
        <div class="text-white">
          <div class="mb-8 flex flex-col items-center">
            <img src="./assets/logos/3DFogCxy/3D FogCxy-logos_transparent.png" width="150" alt=""
              srcset="" />
            <!-- <h1 class="mb-2 text-2xl">3DFogcxy</h1> -->
          ...
          <form action="#">
            ...
            <div class="mt-8 flex justify-center text-lg text-black">
              <button type="submit"
                class="rounded-3xl bg-yellow-400 bg-opacity-50 px-10 py-2 text-white shadow-xl backdrop-blur-md transition-colors duration-300 hover:bg-yellow-600">Ingresar</button>
            </div>
          </form>
        </div>
      </div>
