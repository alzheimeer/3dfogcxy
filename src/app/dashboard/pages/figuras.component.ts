              ...
              @if (figuras.length > 0) {
                @for (figura of figuras; track $index) {
                  <div class="flex flex-col mr-5 text-center mb-11 lg:mr-16">
                    <div [routerLink]="figura.path" class="max-w-xs cursor-pointer rounded-lg bg-white p-2 shadow duration-150 hover:scale-105 hover:shadow-md">
...
export class FigurasComponent {
  ...
  figuras = [
    { url: './assets/modelos/figuras/eagle.jpg', description: 'Aguila', subtitle: 'PLA - Resina', category: 'figuras', path: '/dashboard/modelo' },
    { url: './assets/modelos/figuras/flame_dragon1.jpg', description: 'Dragon Flame', subtitle: 'PLA - Resina', category: 'figuras', path: '/dashboard/modelo' },
    { url: './assets/modelos/figuras/Babu-Grogu.jpg', description: 'Babu Y Grogu', subtitle: 'PLA - Resina', category: 'figuras', path: '/dashboard/modelo' },
    { url: './assets/modelos/figuras/batman_buddha.jpg', description: 'Batman Buddha', subtitle: 'PLA - Resina', category: 'figuras', path: '/dashboard/modelo' },
    { url: './assets/modelos/figuras/eagle.jpg', description: 'Aguila', subtitle: 'PLA - Resina', category: 'figuras', path: '/dashboard/modelo' },
    { url: './assets/modelos/figuras/flame_dragon1.jpg', description: 'Dragon Flame', subtitle: 'PLA - Resina', category: 'figuras', path: '/dashboard/modelo' },
    { url: './assets/modelos/figuras/Babu-Grogu.jpg', description: 'Babu Y Grogu', subtitle: 'PLA - Resina', category: 'figuras', path: '/dashboard/modelo' },
    { url: './assets/modelos/figuras/batman_buddha.jpg', description: 'Batman Buddha', subtitle: 'PLA - Resina', category: 'figuras', path: '/dashboard/modelo' },
