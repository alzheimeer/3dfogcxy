...
@Component({
  ...
  <div class="bg-white relative   flex items-center  n justify-center overflow-hidden z-50 ">
        ...
        <div class="flex flex-col items-center justify-between lg:flex-row py-16">
            <div class=" relative ">
                ...
                <div class="lg:max-w-xl lg:pr-5 relative z-40">
                    ...
                    <h2 class="mb-6 max-w-lg text-5xl font-light leading-snug tracking-tight text-g1 sm:text-7xl sm:leading-snug">
                        Nosotros hacemos que sus ideas luzcan
                        <span class="my-1 inline-block border-b-8 border-g4 bg-white px-4 font-bold text-g4 animate__animated animate__flash">diferente</span>
                    </h2>
                    <p class="text-base text-gray-700">La Fraguita - Bogota, Colombia</p>
                    <p class="text-base text-gray-700">WhatsApp: <span class="whatsapp">3197101696</span></p>
                    <div class="mt-10 flex flex-col items-center md:flex-row">
                        <a href="/" class="mb-3 inline-flex h-12 w-full items-center justify-center rounded bg-green-600 px-6 font-medium tracking-wide text-white shadow-md transition hover:bg-blue-800 focus:outline-none md:mr-4 md:mb-0 md:w-auto">
                            Ver Mas</a>
                        <a href="/" aria-label="" class="group inline-flex items-center font-semibold text-g1">Ver Como Trabajamos
                            <svg  class="ml-4 h-6 w-6 transition-transform group-hover:translate-x-2" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
            ...
            <div class="relative hidden lg:ml-32 lg:block lg:w-1/2">
                ...
                <div class="abg-orange-400 mx-auto w-fit overflow-hidden rounded-[6rem] rounded-br-none rounded-tl-none">
                     <img src="./assets/imagenes/flSL.jpg" width="300px">
                </div>
            </div>
        </div>
    </div>
    <div class="hidden text-9xl varien absolute top-6 left-1/4 text-g/10 z-40">Contactanos</div>
    <div class=" absolute -bottom-24 left-10 z-0  opacity-10 ">
        <svg width="800px" height="800px" viewBox="0 0 24 24" class="w-96 z-0  h-full    object-fill fill-gray-300 text-gray-300" fill="none" >
    ...
    <div class=" absolute -bottom-0 left-3/4 z-0  opacity-10 ">
        <svg width="800px" height="800px" viewBox="0 0 256 256"  class="w-48 z-0  h-full -rotate-90   object-fill fill-red-300 text-red-300">
    ...
    <div class=" absolute top-10 left-3/4 z-0  opacity-10 ">
        ...
        <svg fill="#000000" width="800px" height="800px" viewBox="0 0 256 256"  class="w-96 z-0  h-full    object-fill fill-blue-300 text-blue-300">
